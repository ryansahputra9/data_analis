...
# Watermark
watermark_text = "Dibuat dengan cinta dan sakit kepala oleh Ryan Sahputra, demi memenuhi tugas dari dicoding setelah error yang panjang saat deploy, salam santun, kecup hangat di keningmu :)"
st.markdown(
